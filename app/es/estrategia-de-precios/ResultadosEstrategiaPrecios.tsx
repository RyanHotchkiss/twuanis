    ...
    <section style={workspace}>
      ...
      <section style={hero}>
        ...
        <div style={heroEyebrow}>
          Posición de Precio Recomendada
        </div>
        ...
        <div style={sectionHeader}>
          <div>
            ...
            <h2 style={sectionTitle}>
              Elija Su Posición de Mercado
            </h2>
          </div>

          <p style={sectionDescription}>
            Cada posición refleja un equilibrio diferente
            entre competitividad, tiempo en el mercado
            y ambición de precio.
          </p>
        </div>
      ...
      <section style={section}>
        ...
        <div style={sectionHeader}>
         ...
         <p style={sectionDescription}>
          Evidencia actual del mercado que respalda
          la posición de precio recomendada.
        </p>
        </div>
        ...
        <div style={signalGrid}>
          ...
          <SignalCard
            label="Competencia de Compradores"
            primary={
      ...
      <section style={section}>
        ...
        <div style={sectionHeader}>
          ...
          <p style={sectionDescription}>
            Propiedades actuales que aportan contexto
            de mercado a la recomendación de precio.
          </p>
        </div>
